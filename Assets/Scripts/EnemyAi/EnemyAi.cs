        ...
        _tree = new BehaviorTreeBuilder(gameObject)
            .Selector()
                ...
                .Sequence("Chase Player")
                    .Condition("Has Target", () => _currentTarget != null)
                    .Condition("Target In Range", () => Vector3.Distance(_currentTarget.transform.position, transform.position) <= chaseDistance)
                    //Temporary fix for the attack time limit, so the big dood keeps runing to the player
