...
public class PolygonBeamStatic : MonoBehaviour
{
	...
	public void EnableBeam()
	{
		if (line != null)
		{
			line.enabled = true; // Enable the beam when attacking
		}

		if (beamStart != null)
		{
			beamStart.SetActive(true); // Enable the start particle
		}

		if (beamEnd != null)
		{
			beamEnd.SetActive(true); // Enable the end particle
		}
	}
	...
	public void DisableBeam()
	{
		if (line != null)
		{
			line.enabled = false; // Disable the beam
		}

		if (beamStart != null)
		{
			beamStart.SetActive(false); // Disable the start particle
		}

		if (beamEnd != null)
		{
			beamEnd.SetActive(false); // Disable the end particle
		}
	}
